...
queue. h 
\begin{DoxyPre}
int32\_t queue\_append(                                queue\_t  xQueue,                                const void       *pvItemToQueue,                                uint32\_t     xTicksToWait                            );
  \end{DoxyPre}
...
This is a macro that calls x\+Queue\+Generic\+Send(). It is included for backward compatibility with versions of Free\+RTOS.\+org that did not include the queue\+\_\+prepend() and queue\+\_\+append() macros. It is equivalent to queue\+\_\+append().
...
It is preferred that the macros x\+Queue\+Send(), queue\+\_\+prepend() and queue\+\_\+append() are used in place of calling this function directly.
