...
task. h 
\begin{DoxyPre}void xTaskResumeFromISR( task\_t xTaskToResume );\end{DoxyPre}
...
An implementation of \doxylink{group__c-rtos_ga58bdeeedfe2d98fa57721bb7dad16fee}{task\+\_\+resume()} that can be called from within an ISR.

A task that has been suspended by one or more calls to task\+\_\+suspend () will be made available for running again by a single call to x\+Task\+Resume\+From\+ISR ().
