...
semphr. h 
\begin{DoxyPre}sem\_t xSemaphoreCreateRecursiveMutexStatic( static\_sem\_s\_t *pxMutexBuffer )\end{DoxyPre}
...
{\em px\+Mutex\+Buffer} & Must point to a variable of type static\+\_\+sem\+\_\+s\+\_\+t, which will then be used to hold the recursive mutex\textquotesingle{}s data structure, removing the need for the memory to be allocated dynamically.\\
\hline
\end{DoxyParams}
