\doxysection{stream\+\_\+buf\+\_\+create\+\_\+static}
\hypertarget{group__stream__buf__create__static}{}\label{group__stream__buf__create__static}\index{stream\_buf\_create\_static@{stream\_buf\_create\_static}}
\doxylink{stream__buffer_8h_source}{stream\+\_\+buffer.\+h}


\begin{DoxyPre}
stream\_buf\_t stream\_buf\_create\_static( size\_t xBufferSizeBytes,                                                 size\_t xTriggerLevelBytes,                                                 uint8\_t *pucStreamBufferStorageArea,                                                 static\_stream\_buf\_s\_t *pxStaticStreamBuffer );
\end{DoxyPre}
 Creates a new stream buffer using statically allocated memory. See stream\+\_\+buf\+\_\+create() for a version that uses dynamically allocated memory.

config\+SUPPORT\+\_\+\+STATIC\+\_\+\+ALLOCATION must be set to 1 in \doxylink{_free_r_t_o_s_config_8h_source}{Free\+RTOSConfig.\+h} for stream\+\_\+buf\+\_\+create\+\_\+static() to be available.
...
\hline
{\em px\+Static\+Stream\+Buffer} & Must point to a variable of type static\+\_\+stream\+\_\+buf\+\_\+s\+\_\+t, which will be used to hold the stream buffer\textquotesingle{}s data structure.\\
\hline
\end{DoxyParams}
...
static\_stream\_buf\_s\_t xStreamBufferStruct;

void MyFunction( void )
\{
stream\_buf\_t xStreamBuffer;
const size\_t xTriggerLevel = 1;

    xStreamBuffer = stream\_buf\_create\_static( sizeof( ucBufferStorage ),                                                xTriggerLevel,                                                ucBufferStorage,                                                \&xStreamBufferStruct );
