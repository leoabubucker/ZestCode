...
queue. h 
\begin{DoxyPre}
 int32\_t xQueueOverwriteFromISR(                               queue\_t xQueue,                               const void * pvItemToQueue,                               int32\_t *pxHigherPriorityTaskWoken                          );
   \end{DoxyPre}


A version of queue\+\_\+overwrite() that can be used in an interrupt service routine (ISR).
...
int32\_t xHigherPriorityTaskWoken = pdFALSE;
