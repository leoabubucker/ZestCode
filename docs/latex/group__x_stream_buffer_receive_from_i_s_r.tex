...
\begin{DoxyPre}
size\_t xStreamBufferReceiveFromISR( stream\_buf\_t xStreamBuffer,                                     void *pvRxData,                                     size\_t xBufferLengthBytes,                                     int32\_t *pxHigherPriorityTaskWoken );
\end{DoxyPre}


An interrupt safe version of the API function that receives bytes from a stream buffer.

Use stream\+\_\+buf\+\_\+recv() to read bytes from a stream buffer from a task. Use x\+Stream\+Buffer\+Receive\+From\+ISR() to read bytes from a stream buffer from an interrupt service routine (ISR).
