...
\begin{DoxyPre}
msg\_buf\_t xMessageBufferCreateStatic( size\_t xBufferSizeBytes,                                                   uint8\_t *pucMessageBufferStorageArea,                                                   static\_msg\_buf\_s\_t *pxStaticMessageBuffer );
\end{DoxyPre}
...
\hline
{\em px\+Static\+Message\+Buffer} & Must point to a variable of type static\+\_\+msg\+\_\+buf\+\_\+s\+\_\+t, which will be used to hold the message buffer\textquotesingle{}s data structure.\\
\hline
\end{DoxyParams}
...
static\_msg\_buf\_s\_t xMessageBufferStruct;

void MyFunction( void )
\{
msg\_buf\_t xMessageBuffer;
