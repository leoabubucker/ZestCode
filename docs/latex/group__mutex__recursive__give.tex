...
semphr. h 
\begin{DoxyPre}\doxylink{group__c-rtos_gaaf82d93cd652b6173372970018fdc02d}{mutex\_recursive\_give( sem\_t xMutex )}\end{DoxyPre}


{\itshape Macro} to recursively release, or \textquotesingle{}give\textquotesingle{}, a mutex type semaphore. The mutex must have previously been created using a call to \doxylink{group__c-rtos_gab32c3cf41f7dbde49dfac10c279347f0}{mutex\+\_\+recursive\+\_\+create()};
...
{\em x\+Mutex} & A handle to the mutex being released, or \textquotesingle{}given\textquotesingle{}. This is the handle returned by \doxylink{group__c-rtos_ga475d096afa3abcc9a276ca9fa54bafdf}{mutex\+\_\+create()};\\
\hline
\end{DoxyParams}
...
\{
   ...
   \{
       ...
       \{
        ...
        // to \doxylink{group__c-rtos_gaaf82d93cd652b6173372970018fdc02d}{mutex\_recursive\_give()} would be called as a call stack
