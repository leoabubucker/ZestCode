...
\begin{DoxyPre}
size\_t xMessageBufferReceiveFromISR( msg\_buf\_t xMessageBuffer,                                      void *pvRxData,                                      size\_t xBufferLengthBytes,                                      int32\_t *pxHigherPriorityTaskWoken );
\end{DoxyPre}
...
int32\_t xHigherPriorityTaskWoken = pdFALSE;  // Initialised to pdFALSE.
