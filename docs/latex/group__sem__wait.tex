...
semphr. h 
\begin{DoxyPre}sem\_wait(                     sem\_t xSemaphore,                     uint32\_t xBlockTime                 )\end{DoxyPre}


{\itshape Macro} to obtain a semaphore. The semaphore must have previously been created with a call to sem\+\_\+binary\+\_\+create(), mutex\+\_\+create() or sem\+\_\+create().
