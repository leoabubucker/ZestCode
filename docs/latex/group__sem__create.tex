\doxysection{sem\+\_\+create}
\hypertarget{group__sem__create}{}\label{group__sem__create}\index{sem\_create@{sem\_create}}
semphr. h 
\begin{DoxyPre}sem\_t \doxylink{group__apix_ga382f9b5dc6ba96dcecffdbd7f41d29ac}{sem\_create( uint32\_t uxMaxCount, uint32\_t uxInitialCount )}\end{DoxyPre}
...
sem\_t xSemaphore = NULL;
   ...
   // Semaphore cannot be used before a call to \doxylink{group__apix_ga382f9b5dc6ba96dcecffdbd7f41d29ac}{sem\_create()}.
   // The max value to which the semaphore can count should be 10, and the
   // initial value assigned to the count should be 0.
   xSemaphore = sem\_create( 10, 0 );
